        ...
        <div id="secaoCapa" class="carousel slide d-none d-md-block" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100 img-carousel" src="img/Principal/capaSerra.jpg" alt="First slide">
                ...
                <div class="carousel-item">
                    <img class="d-block w-100 img-carousel" src="img/Principal/capaComp.jpg" alt="Second slide">
                    <div class="carousel-caption carousel-vertical-center d-none d-md-block">
                ...
                <div class="carousel-item">
                    <img class="d-block w-100 img-carousel" src="img/Principal/capaMec.jpg" alt="Third slide">
                    <div class="carousel-caption carousel-vertical-center d-none d-md-block">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 containerServicos">
                        <a id="projetosMecanicos" class="linksServicos" href="mecanica.php">
                            <div>
                    ...
                    <div class="col-md-4 containerServicos">
                        <a id="projetosAutomacao" class="linksServicos" href="computacao.php">
                            <div>
                    ...
                    <div class="col-md-4 containerServicos">
                        <a id="projetosWEB" class="linksServicos" href="computacao.php#Desenvolvimento_web">
                            <div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 acessarBlog">
                        <center><a class="botaoEstilizado" href="blogHome.php"> Acessar Blog </a></center>
                    </div>
                </div>
            </div>
