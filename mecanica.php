                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="texto"> 
                                Quer colocar suas ideias em prática? A Serra Jr realiza 
                                projetos de desenvolvimento de máquinas e/ou equipamentos a 
                                partir do zero ou otimizações desses.
                            </p>
                        </div>
                    </div>
                    <div class="row"> 
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container">
                            ...
                            <div class="col-md-12" >
                                <p class="modal_texto">O Desenho Técnico é um investimento essencial para o seu empreendimento, já que seus benefícios vão muito além de facilitar a execução do projeto por demonstrar todos os detalhes necessários. 
                                    Ao optar por esse tipo de serviço, seja para o seu maquinário, peças ou qualquer outro tipo de produto, você facilita o controle e o acesso a informações essenciais tendo um impacto significativo na sua organização, nos resultados entregues pela sua equipe e no saldo final da sua empresa. 
                                    Utilizando softwares CAD, a Serra Jr irá elaborar um modelo contendo as características, funcionalidades e requisitos do produto permitindo assim a sua fabricação e/ou seu registro em patente. 
                                    Com a conclusão do projeto serão gerados os desenhos técnicos, e caso seja necessário, relatórios e manuais de montagem.</p>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container">
                            <div class="col-md-12" >
                                <p class="modal_texto">O uso de protótipos pode ser uma excelente ferramenta para auxiliar no processo de especificação funcional, principalmente porque eles representam um modelo simplificado do produto final. 
                                    A Serra Jr. elabora protótipos utilizando a <span class="modal_sublinhado_1">impressão 3D</span> proporcionando ao cliente: </p>
                                <ul>
                        ...
                        <div class="container">
                            <div class="col-md-12" >
                                <p class="modal_texto">Com o objetivo de diminuir os riscos ao projetar uma estrutura, a Serra Jr realiza projetos de Análise estrutural, modelando e analisando cargas aplicadas à estrutura, suas reações a fim de encontrar os pontos da estrutura que são sujeitos a falhas, utilizando o método dos Elementos Finitos. 
                                    A análise estrutural fornece resultados utilizados para identificar a durabilidade do componente, identificar pontos de concentração de tensão, entender o comportamento da estrutura diante de um carregamento e fazer com que a otimização de peças seja feita antes mesmo de fabricá-las.</p>
                                <p class="modal_texto"># Gostaria de saber se a Serra Jr pode te ajudar? Contate-nos e peça um orçamento ou agende uma reunião sem compromisso preenchendo os dados do nosso formulário de contato a seguir. #</p>
                            </div>
                        </div>
                        <div class="container">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container">
                            <div class="col-md-12" >
                                <p class="modal_texto">A Serra Jr realiza projetos de desenvolvimento de máquinas a partir do zero ou otimizações dos já existentes, avaliando a viabilidade técnica de todos os seus componentes. 
                                    Através de cálculos, simulações computacionais, estudo de materiais e de sistemas auxiliares é elaborado um relatório e um manual de fabricação, possibilitando a obtenção de patente da peça ou do equipamento idealizado.</p>
                                <p class="modal_texto"># Gostaria de saber se a Serra Jr pode te ajudar? Contate-nos e peça um orçamento ou agende uma reunião sem compromisso preenchendo os dados do nosso formulário de contato a seguir. #</p>
                            </div>
                        </div>
                        <div class="container">
