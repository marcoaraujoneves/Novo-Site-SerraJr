...
for ($i=1; $i <= $quantidade ; $i++) { 
	...
	$vet .= '<img class="imagem_postagem m-3 d-block mx-auto img-fluid" src="Img/marcoGostoso/'.$_FILES['id'.$i][ 'name' ].'">';
}
...
<?php include("inicio.php");
 echo "<script>mudarTitulo('.$asp.''.$vet[1].''.$asp.');</script>"; ?>
...
file_put_contents('marcoGostoso.php', $conteudo);
